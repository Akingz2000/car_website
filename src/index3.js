        ...
        <div    ref={A} onClick= {Look1}     className= {h}></div>
          ...
          <section className="side-bar__holder">
               ...
               <ul className="side-bar__ul">
                 ...
                 <li onClick={executeScroll22} className="side-bar__li">cars</li>
                 <li onClick={executeScroll33} className="side-bar__li"> prices</li>
                 <li onClick={executeScroll44} className="side-bar__li">team</li>
                 <li onClick={executeScroll55} className="side-bar__li">contact us</li>
               </ul>
